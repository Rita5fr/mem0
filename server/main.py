...
def get_memory(memory_id: str, _: str = Depends(verify_api_key)):
...
def update_memory(memory_id: str, updated_memory: Dict[str, Any], _: str = Depends(verify_api_key)):
...
def memory_history(memory_id: str, _: str = Depends(verify_api_key)):
...
def delete_memory(memory_id: str, _: str = Depends(verify_api_key)):
...
def reset_memory(_: str = Depends(verify_api_key)):
